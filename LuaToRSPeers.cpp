...
extern "C" {
    ...
    int rs_peers_getOwnId(lua_State* L)
    {
    ...
    int rs_peers_getOnlineList(lua_State* L)
    {
    ...
    int rs_peers_getFriendList(lua_State* L)
    {
        std::list<std::string> ids;
    ...
    int rs_peers_getPeerCount(lua_State* L)
    {
    ...
    int rs_peers_getPeerName(lua_State* L)
    {
        if( getArgCount(L) != 1)
            return 0;
    ...
    int rs_peers_getPeerDetails(lua_State* L)
    {
        if( getArgCount(L) != 1)
            return 0;
